...
const HERO_PHONES = [
  ...
  },
  {
    ...
    time: '1:47 PM',
    messages: [
      { from:'ai',   text:"Hi — thanks for calling Rodriguez Plumbing. The team is currently on a job and should be available around 3 PM. How can I help?" },
      { from:'user', text:"Can you just have someone call me back?" },
      { from:'ai',   text:"Of course. I'll make sure they see this the moment they're free. Is this the best number to reach you?" },
      { from:'user', text:"Yes this number" },
      { from:'ai',   text:"Got it — you'll get a call back by 3 PM. Anything you'd like me to pass along so they're prepared?" },
    ],
    banner: null,
