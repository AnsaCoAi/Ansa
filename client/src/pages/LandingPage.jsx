...
const HERO_PHONES = [
  {
    ...
    time: '10:23 AM',
    messages: [
      { from:'ai',   text:"Hi, this is Mike's Plumbing! We missed your call and want to help. How can we assist you today?" },
      { from:'user', text:"I have a leaking pipe under my kitchen sink" },
      { from:'ai',   text:"We can definitely help with that. We have a 2:00 PM opening today — want me to book it?" },
      { from:'user', text:"Yes please" },
      { from:'ai',   text:"Your appointment with Mike's Plumbing is confirmed for today at 2:00 PM. We'll see you then!" },
    ],
  ...
  },
  {
    ...
    time: '1:47 PM',
    messages: [
      { from:'ai',   text:"Hi! Rodriguez Plumbing here — we missed your call. What can we help you with?" },
      { from:'user', text:"Just need someone to call me back when free" },
      { from:'ai',   text:"We want to make sure you get taken care of. I'll flag this for the team — is this the best number to reach you?" },
      { from:'user', text:"Yes this number is fine" },
      { from:'ai',   text:"Got it. Someone will call you back shortly. Thanks for reaching out!" },
    ],
    banner: null,
  ...
  },
  {
    ...
    time: '11:42 PM',
    messages: [
      { from:'ai',   text:"Hi, this is Chen's Heating & Air! We missed your call and want to help. How can we assist you today?" },
      { from:'user', text:"AC isn't working, it's 85 degrees in here" },
      { from:'ai',   text:"We want to make sure you get taken care of. Our first opening is tomorrow at 8:00 AM — want me to book that?" },
      { from:'user', text:"Please yes" },
      { from:'ai',   text:"Your appointment with Chen's Heating & Air is confirmed for tomorrow at 8:00 AM. We'll see you then!" },
    ],
