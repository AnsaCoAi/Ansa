  ...
  return (
    <div style={s.page}>
      <div style={s.inner}>
        ...
        <p style={s.p}>SMS messages sent through Ansa include missed call alerts, appointment confirmations, and two-way customer care conversations. <strong style={{ color: '#ddd' }}>Message frequency varies.</strong> Message and data rates may apply. Reply <strong style={{ color: '#ddd' }}>STOP</strong> to opt out. Reply <strong style={{ color: '#ddd' }}>HELP</strong> for help or contact us at {EMAIL}. Carriers are not liable for delayed or undelivered messages. View our <a href="#/privacy" style={{ color: '#3b82f6', textDecoration: 'none' }}>Privacy Policy</a>.</p>
