  ...
  return (
    <div style={s.page}>
      <div style={s.inner}>
        ...
        <p style={s.p}><strong style={{ color: '#ddd' }}>No mobile information will be shared with third parties or affiliates for marketing or promotional purposes.</strong> Ansa Co LLC will not share your mobile number or SMS opt-in data with any third party for marketing or promotional purposes. Phone numbers collected through SMS opt-in will not be shared with any third party for purposes unrelated to providing the Ansa service. All the above categories exclude text messaging originator opt-in data and consent; this information will not be shared with any third parties. All other categories of personal information may be shared with third parties only as described in this Privacy Policy.</p>
