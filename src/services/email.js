...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  ...
  <table width="520" cellpadding="0" cellspacing="0" style="background:#111111;border-radius:16px;border:1px solid #222;"><tr><td style="padding:40px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="border-top:1px solid #1f1f1f;padding-top:20px;">
      <div style="font-size:13px;color:#444;margin-bottom:6px;">Questions? Reply to this email — we're here to help.</div>
  ...
  await resend.emails.send({
    ...
    html: emailWrapper(`
      <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding-bottom:8px;">
        ...
        <div style="font-size:14px;color:#777;text-align:center;line-height:1.7;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;"><tr><td style="background:#141414;border:1px solid #222;border-radius:12px;padding:24px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr><td style="padding:6px 0;font-size:14px;color:#aaa;">📞&nbsp; Missed calls trigger an automatic text-back</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#aaa;">🤖&nbsp; Your AI assistant handles replies and books appointments</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#aaa;">📊&nbsp; Every conversation appears in your Ansa dashboard</td></tr>
        </table>
      </td></tr></table>
...
async function sendCancellationEmail({ to, ownerName, businessName }) {
  await resend.emails.send({
    ...
    html: emailWrapper(`
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;"><tr><td style="background:#141414;border:1px solid #222;border-radius:12px;padding:24px;">
        <div style="font-size:14px;color:#aaa;line-height:1.7;text-align:center;">
  ...
  await resend.emails.send({
    ...
    html: emailWrapper(`
      ...
      <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding-bottom:4px;">
        <div style="font-size:11px;font-weight:700;color:#aaa;letter-spacing:1px;text-transform:uppercase;">${month} Summary</div>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;"><tr>
        ...
        <td width="140" align="center" style="padding:0 4px;">
          <table width="140" cellpadding="0" cellspacing="0" style="background:#141414;border:2px solid #a78bfa;border-radius:12px;"><tr><td align="center" style="padding:20px 8px;">
            ...
            <div style="font-size:11px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:0.5px;">Questions Answered</div>
          </td></tr></table>
        </td>
      </tr></table>
